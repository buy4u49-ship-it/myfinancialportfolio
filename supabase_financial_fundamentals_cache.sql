create table if not exists public.financial_fundamentals_cache (
  ...
  previous_operating_income numeric,
  net_income numeric,
...
alter table public.financial_fundamentals_cache
  ...
  add column if not exists previous_revenue numeric,
  add column if not exists operating_income numeric,
  add column if not exists previous_operating_income numeric,
  add column if not exists net_income numeric,
  add column if not exists previous_net_income numeric,
